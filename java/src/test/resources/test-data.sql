BEGIN TRANSACTION;
--original user PW: $2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC
--original admin PW: $2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC
INSERT INTO users (username,password_hash,role) VALUES ('user','user1','ROLE_USER');
INSERT INTO users (username,password_hash,role) VALUES ('admin','user2','ROLE_ADMIN');
INSERT INTO users (username,password_hash,role) VALUES ('kyle', 'user3', 'ROLE_USER');
